package com.arc.pageLibrary.registrationPage.MyCommunities;
...
public class IndProjectRegisterPage extends TestBase{
	...
	{	
		getWebElement("ClickOnCommunity").click();
		...
		getWebElement("arc.ratings.community").click();
		getWebElement("arc.projecttype.leed.community").click();
