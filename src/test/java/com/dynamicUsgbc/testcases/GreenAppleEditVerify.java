...
public class GreenAppleEditVerify extends BaseClass{

	@Test
	@Parameters({"rowNum" ,"PaymentSheet","SignInSheet","donationSheet"})
	public void greenAppleDonationFlow(int rowNum,String paymentSheet,String signInSheet,String donationSheet) throws Exception {
		...
		CommonMethod.sleep(3000);
		CommonMethod.takeScreenshot("DonationGreenEditVerify");
