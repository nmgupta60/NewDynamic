...
public class GreenCouncilEditVErify extends BaseClass{

	
	@Test
	@Parameters({"rowNum" ,"PaymentSheet","SignInSheet","donationSheet"})
	public void donationGreenCouncilFlow(int rowNum,String paymentSheet,String signInSheet,String donationSheet) throws IOException  {
		...
		String newAmount = data.getCellData(donationSheet,"newAmount", rowNum);
	    ...
	    CommonMethod.click("DonationEditOnPaymentPage");
	    CommonMethod.sleep(2000);
	    CommonMethod.selectdropdown("SelDonationAmt", newAmount);
	    System.out.println("Amount changed to 100");
	    CommonMethod.click("CommunityContinue");
	    CommonMethod.sleep(2000);
	    
	    CommonMethod.assertEqualsmessage("VerifyDonationAmount", newAmount, "Amount didn't matched");
...
//		CommonMethod.assertEqualsmessage("ReceiptDonationDonatedBy", donorName, "Donor Name is not correct");
		...
		CommonMethod.takeScreenshot("DonationGreenCouncilEditVerify");
